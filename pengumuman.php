        ...
        <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light">
            ...
            <div class="row right ">
                <div class="mt-5 col-md-12">
                    <div class=" col-12">
                        <h3>Nama Lengkap &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <span class="ml-5">Nama Lengkap Mahasiswa</span> </h3>
                    </div>
                    <div class=" col-12">
                        <h3>Kategori Proposal &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <span class="ml-5">Machine Learning</span></h3>
                    </div>
                    <div class="judprop col-md-12 text-center">
                        <h3>Judul Proposal:</h3> <br>
                        <h2>Peninjauan Interaksi Antara Manusia 
                            Dengan Teknologi Robot Menggunakan  Perantara 
                            Analysis Machine Learning
                        </h2>
                    </div>
                    <div class="status col-md-12">
                        <h3> Status Proposal &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp : 
                            ...
                            <button  class="badge badge-pill badge-danger">Ditolak</button> -->
                        </h3>
                </div>
